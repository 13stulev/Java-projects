...
public class School_teacher implements Teacherable, Serializable{
	...
	public School_teacher(String[] les,String name, int count) {
	...
	public boolean equals(Object obj)
	{
		...
		School_teacher check=(School_teacher)obj;
	...
	public void output(OutputStream out) throws IOException{
		...
		public void write(Writer out){
			...
			String result = "";
			result = false + " " + name + " " + coutOfStudents + " " + lessons.length + " ";
			for (String lesson : lessons)
				result += lesson + " ";
